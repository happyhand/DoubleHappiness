...
using DataInfo.Service.Managers.User;
...
namespace DataInfo.Api
{
    ...
    public class Startup
    {
        ...
        private void SwaggerHandler(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "天光水晶 API", Version = "v1" });
                ...
                var xmlPath = Path.Combine(basePath, "TianguangCrystal.API.Swagger.xml");
        ...
        public static void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "TianguangCrystal API");
            });
